module.exports = options = {
    ...
    "states": [
      ...
      },
      {
            ...
            "conditions": [
              {
                "friendly_name": "1",
                "arguments": [
                  "{{widgets.product_ending_digit.Choice}}"
                ],
                "type": "equal_to",
                "value": "1"
              }
        ...
        "properties": {
          "input": "{{widgets.product_ending_digit.Choice}}",
          "offset": {
            "x": 2200,
            "y": -20
          }
      ...
      },
      {
            ...
            "conditions": [
              {
                "friendly_name": "1",
                "arguments": [
                  "{{widgets.product_ending_speech.Choice}}"
                ],
                "type": "equal_to",
                "value": "1"
              }
        ...
        "properties": {
          "input": "{{widgets.product_ending_speech.Choice}}",
          "offset": {
            "x": 2190,
            "y": 220
          }
      ...
      },
      {
        ...
        "properties": {
          ...
          "loop": 1,
          "finish_on_key": "#",
          "say": "press 1 to repeat the list of promotions,\n\npress 0 to talk to a customer representative,\n\nor press the pound key to return to the main menu",
          "language": "en-US",
          "stop_gather": false,
          "gather_language": "en",
          "profanity_filter": "true",
